...
GWS_SCOPE_PRESETS = {
    ...
    "standard": {
        ...
        "description": "Read and write emails, calendar events, drive files, spreadsheets, docs, etc.",
        "scopes": [
            "openid",
            "email",
            "profile",
    ...
    "full": {
        "label": "Full Access",
        "description": "All Google Workspace permissions including admin and Pub/Sub",
        "scopes": [
            "openid",
            "email",
            "profile",
...
GWS_AVAILABLE_SCOPES = [
    ...
    {"scope": "https://www.googleapis.com/auth/chat.messages", "label": "Chat (Messages)", "category": "Chat"},
    {"scope": "https://www.googleapis.com/auth/chat.spaces.readonly", "label": "Chat (Spaces Read)", "category": "Chat"},
    {"scope": "https://www.googleapis.com/auth/chat.spaces", "label": "Chat (Spaces Full)", "category": "Chat"},
    {"scope": "https://www.googleapis.com/auth/forms.body", "label": "Forms", "category": "Forms"},
    {"scope": "https://www.googleapis.com/auth/keep", "label": "Keep", "category": "Keep"},
    {"scope": "https://www.googleapis.com/auth/script.projects", "label": "Apps Script", "category": "Apps Script"},
    {"scope": "https://www.googleapis.com/auth/admin.reports.audit.readonly", "label": "Admin Reports (Read)", "category": "Admin"},
    {"scope": "https://www.googleapis.com/auth/classroom.courses", "label": "Classroom", "category": "Classroom"},
    {"scope": "https://www.googleapis.com/auth/pubsub", "label": "Pub/Sub", "category": "Cloud"},
    {"scope": "https://www.googleapis.com/auth/cloud-platform", "label": "Cloud Platform", "category": "Cloud"},
]
